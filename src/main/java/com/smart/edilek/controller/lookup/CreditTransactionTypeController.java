...
public class CreditTransactionTypeController {
    ...
    @GetMapping("/list")
    @Operation(summary = "Get all credit transaction types", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<List<CreditTransactionType>> getAll() {
        try {
