...
public class PetitionPreferencesStyleController {
    ...
    @GetMapping("/list")
    @Operation(summary = "Get all petition preferences styles", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<List<PetitionPreferencesStyle>> getAll() {
        try {
